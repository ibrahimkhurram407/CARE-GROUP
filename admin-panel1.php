        ...
        <div class="row">
            <div class="col-md-4" style="max-width:25%;margin-top: 3%;">
                <div class="list-group" id="list-tab" role="tablist">
                    ...
                    <a class="list-group-item list-group-item-action" href="#list-city" id="list-city-list" role="tab"
                        data-toggle="list" aria-controls="home">Manage Cities</a>
                ...
                <div class="tab-content" id="nav-tabContent" style="width: 950px;">
                  ...
                  ?>
                    ...
                    if (isset($_POST['deleteCity'])) {
                        ...
                        // Delete all doctors from the selected city
